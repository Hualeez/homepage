...
const SITE = {
  ...
  profile:  { image: "src/profile.png", alt: "Yichen Cai" },

  bio: {
    zh: `你好，我是蔡逸晨，现于浙江大学攻读人工智能博士研究生，师从 <a href="https://person.zju.edu.cn/sly/623051.html">孙凌云</a> 教授与<a href="https://person.zju.edu.cn/chenpei">陈培</a>老师。本科毕业于浙江大学竺可桢学院图灵班。研究聚焦于大语言模型、智能体、人机交互与以人为中心的 AI 研究。研究成果发表于 JMD, JED, CHI, ACL 等顶级会议和期刊。`,
  ...
  education: [
    ...
    {
      school: { zh: "浙大竺可桢学院图灵班",  en: "Zhejiang University, Chu Kochen College" },
  ...
  papers: [
    ...
    },
    {
      ...
      authors: ["Pei Chen", "Yichen Cai", "Zihong Zhou", "Jiayi Yao", "Jiayang Li", "Weitao You", "Lingyun Sun"],
      me:      "Yichen Cai",
